...
keywords: ["gh api graphql", "discussion", "arcbook", "addDiscussionComment", "category-id"]
---
...
- **Before filing a new issue:** search your own recent issues on the same topic first:
  ```bash
  gh issue list --repo <owner/repo> --search "<topic keywords>" --state all --author arc-evolve
  ```
