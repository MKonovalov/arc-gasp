...
This skill covers **any** codebase the agent encounters — forks, dependencies, unfamiliar regions, user projects. For analyzing arc's own source to find bugs and gaps, use `self-assess` instead.
